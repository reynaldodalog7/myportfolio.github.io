            ...
            function get_module_component_settings()
                {
                    $this->component_settings[]                  =   array(
                                                                    ...
                                                                    'description'   =>  __('Your default wp-content path is set to',    'wp-hide-security-enhancer') . ' <strong>'.   $this->wph->default_variables['content_directory'] .'</strong>
                                                                                        '. __('More details can be found at',    'wp-hide-security-enhancer') .' <a href="https://www.wp-hide.com/documentation/rewrite-wp-content/" target="_blank">Link</a>',
                                    ...
                                    if ( ! is_multisite()   ||  (   is_multisite() &&  $ms_settings['allow_every_site_to_change_options']  ==  'no'   &&  SUBDOMAIN_INSTALL   === FALSE ))
                                        {
                                            ...
                                            $rewrite_data               =   "rewrite ^". untrailingslashit($home_root_path) ."__WPH_SITES_SLUG__/". untrailingslashit($rewrite_base) ."(.+) ". $rewrite_to .' last;';    
