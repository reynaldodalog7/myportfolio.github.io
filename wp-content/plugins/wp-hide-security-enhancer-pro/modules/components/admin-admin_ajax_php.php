            ...
            function get_module_component_settings()
                {
                    ...
                    $component_description  =   array(
                                                        __('Map a new slug for admin-ajax.php.',  'wp-hide-security-enhancer') . '<br />'
                                                        . __('More details can be found at',    'wp-hide-security-enhancer') .' <a href="https://www.wp-hide.com/documentation/admin-change-default-admin-ajax-php/" target="_blank">Link</a>'
                                                        );
            ...
            function _callback_saved_new_admin_ajax_php($saved_field_data)
                {
                    ...
                    $rewrite_to         =   $this->wph->functions->get_rewrite_to_base( '/wp-admin/admin-ajax.php' , TRUE, FALSE, 'site_path' );
