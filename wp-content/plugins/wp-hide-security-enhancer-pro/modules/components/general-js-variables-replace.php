<?php
    ...
    class WPH_module_general_js_variables_replace extends WPH_module_component
        {
            ...
            function get_component_title()
                {
                    return "JavaScript Variables Replace";
                }
            ...
            function get_module_component_settings()
                {
                    ...
                    $this->component_settings[]                  =   array(
                                                                    'id'            =>  'js_variables_replace',
                                                                    'label'         =>  __('JavaScript Variables Replace',    'wp-hide-security-enhancer'),
                                                                    'description'   =>  '<span class="info">' . __('This require the ', 'wp-hide-security-enhancer') . '<a href="admin.php?page=wp-hide-general-js&component=javascript-combine">' . __('JavaScript Combine', 'wp-hide-security-enhancer') . '</a>' . __(' to be set to Yes.', 'wp-hide-security-enhancer') . '</span>' .
                                                                                        '<br />' .  __('This option apply only for front side.', 'wp-hide-security-enhancer') .  __('Arbitrary JavaScript variables replacement from inline JS / assets files located on local instance. The word case it used acordingly, as JavaScript variables are case sensitive.',  'wp-hide-security-enhancer') 
                                                                                        . '<br /><br /><span class="info"> <b>' . __('Caution ! ', 'wp-hide-security-enhancer') . '</b>'.__('This can produce JavaScript errors and layout issues with certain replacements or in case of erroneously usage. If something break, the replacement should be removed.', 'wp-hide-security-enhancer') . '</span>',
            ...
            function _module_option_html( $module_setting )
                {
                    ...
                    $values =   $this->wph->functions->get_site_module_saved_value('js_variables_replace',  $this->wph->functions->get_blog_id_setting_to_use(), 'display');
            ...
            function _module_option_processing( $field_name )
                {
                    ...
                    $data       =   $_POST['js_variables_replace'];
                    $values     =   array();
